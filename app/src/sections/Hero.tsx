...
const Hero = () => {
  ...
  return (
    <section
      ...
      style={{ perspective: '1500px', isolation: 'isolate', clipPath: 'inset(0)' }}
    >
      {/* Binary rain canvas */}
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/20 rounded-full blur-[120px] animate-pulse" style={{ pointerEvents: 'none' }} />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-cyan-500/20 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '1s', pointerEvents: 'none' }} />
